...
namespace adftestCom
{
  ...
  public class MyAdfTest : IDisposable
  {
    ...
    ///
    public MWArray adftest()
    {
      return mcr.EvaluateFunction("adftest", new MWArray[]{});
    }
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray adftest(MWArray y)
    {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray adftest(MWArray y, params MWArray[] varargin)
    {
      MWArray[] args = {y};
      ...
      return mcr.EvaluateFunction("adftest", (MWArray[])newArr );
    }
    ...
    /// arguments.</returns>
    ///
    public MWArray[] adftest(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "adftest", new MWArray[]{});
    }
    ...
    /// arguments.</returns>
    ///
    public MWArray[] adftest(int numArgsOut, MWArray y)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] adftest(int numArgsOut, MWArray y, params MWArray[] varargin)
    {
      MWArray[] args = {y};
      int nonVarargInputNum = args.Length;
      int varargInputNum = varargin.Length;
      ...
      return mcr.EvaluateFunction(numArgsOut, "adftest", (MWArray[])newArr );
    }
    ...
    ///
    public void adftest(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("adftest", numArgsOut, ref argsOut, argsIn);
    }
